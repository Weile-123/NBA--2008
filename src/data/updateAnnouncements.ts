...
export const UPDATE_ANNOUNCEMENTS: UpdateAnnouncement[] = [
  {
    ...
    title: '第九次更新说明',
    introduction: ['新增中国球员成长路线，并优化两种模式的比赛、阵容与荣誉体验。'],
    versions: [{ version: 'v9', sections: [
      { title: '创建与成长', items: [
        '创建球员可选择主次位置和身材，自动匹配专属模板；更多联盟球员支持双位置。',
        '创建球员可选择中国或海外，体验不同的 15 阶段成长故事。',
        '季后赛亲自出战也可获得经验与属性点。',
      ] },
      { title: '阵容与比赛', items: [
        '优化双位置首发搭配与阵容排序，减少首发缺人、球员定位错乱。',
        '平行联盟的随机交易更注重位置深度，球星邀请更贴合球队缺口。',
        '优化亲自出战的比分推进，减少不合理的极端反超。',
      ] },
      { title: '赛季荣誉', items: [
        '新增篮板王、助攻王、抢断王、盖帽王和三分王，并简化赛季荣誉展示。',
        '生涯荣誉改为双列展示；新增数据王仅在游戏内记录，不影响 GOAT 积分与全网榜。',
        '优化最佳防守球员评选，让出色的防守表现获得更合理的认可。',
