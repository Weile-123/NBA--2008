...
export const UPDATE_ANNOUNCEMENTS: UpdateAnnouncement[] = [
  {
    ...
    introduction: [
      ...
      'v8 重点加入“平行联盟”新模式，并继续完善经典模式的比赛、荣誉、属性与移动端体验。',
      '两个模式各自保留一个独立存档，并拥有互不混排的个人传奇榜与全网传奇榜。',
    ],
        ...
        sections: [
          {
            ...
            items: [
              ...
              '加入球星邀请计划、球队方向查看，以及独立的存档、个人传奇榜和全网传奇榜。',
            ],
          },
          {
            title: '属性溢出奖励',
          ...
          },
          {
            ...
            items: [
              ...
              '命定事件列表支持折叠，详情改为固定标题、滚动内容和固定操作按钮。',
              '优化平行联盟玩法说明、赛季模拟暂停及多项页面交互。',
            ],
          },
        ],
      },
