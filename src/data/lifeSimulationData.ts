import { DOMESTIC_LIFE_STORIES } from './domesticLifeStories';
...
function getDomesticLifeSimulationEvents(): LifeEvent[] {
  return DOMESTIC_LIFE_STORIES.map((entry) => ({
    ...entry,
...
export function get15LifeSimulationEvents(
  ...
  if (birthplace === '中国') return getDomesticLifeSimulationEvents();
